...
public class IndicatorDailyOHLC : Indicator
{
    ...
    public string OpenCustomText = "O: ", HighCustomText = "High of Week: ", LowCustomText = "Low of Week: ", CloseCustomText = "C: ", MiddleCustomText = "M: ";
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        if (inSession)
        {
            ...
            this.currentRange.EndDateTime = GetWeekStart(currentBarTime).AddDays(7);
    ...
    public override IList<SettingItem> Settings
    {
        ...
        set
        {
            ...
            if (holder.TryGetValue("HighLineOptions", out SettingItem item) && item.Value is LineOptions highOptions)
...
public enum WeeklyOHLCLabelPosition { Left, Center, Right }
